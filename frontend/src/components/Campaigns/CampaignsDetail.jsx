...
import "./CampaignsDetail.css";

const CampaignsDetail = () => {
    
  return (
<section className="single-campaigns">
<div className="container">
        <article>
        <figure>
            <a href="#">
            <img src="/img/bloggg.webp" alt=""/>
            </a>
          </figure>
          <div className="campaigns-wrapper">
            <div className="campaigns-meta">
              <div className="campaigns-category">
                <span>COLLECTION</span>
              </div>
              <div className="campaigns-date">
                <span>April 25, 2022</span>
              </div>
              <div className="campaigns-tags">
                <span>products</span>, <span>coats</span>
              </div>
            </div>
            <h1 className="campaigns-title">The Best Products That Shape Fashion</h1>
